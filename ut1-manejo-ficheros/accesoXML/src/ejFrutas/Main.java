				...
				if (nodo.getNodeType() == Node.ELEMENT_NODE) {
					...
					for (int j = 0; j < 1; j++) {
						...
						if (nodo2.getNodeType() == Node.ELEMENT_NODE) {
							String nutriente = fruta.getElementsByTagName("nutriente").item(0).getTextContent();
							String nutriente2 = fruta.getElementsByTagName("nutriente").item(1).getTextContent();
							System.out.println("Y sus nutriente son: " + nutriente);
							System.out.println("Y sus nutriente son: " + nutriente2);
						}
					}
